...
Future fetchAlbum() async {
  final response = await http.get(Uri.parse('https://api.ipgeolocation.io/timezone?apiKey=667e23afdf864d1d9d89e741ed17452b&location=Udupi'));
  if (response.statusCode == 200) {
    print(jsonDecode(response.body)["date_time"]);
